...
import { FastifyBaseLogger, FastifyLoggerInstance, FastifyLoggerOptions, PinoLoggerOptions } from 'fastify/types/logger'
...
export { FastifyListenOptions, FastifyInstance, PrintRoutesOptions } from 'fastify/types/instance'
export { FastifyLoggerOptions, FastifyBaseLogger, FastifyLoggerInstance, FastifyLogFn, LogLevel } from 'fastify/types/logger'
export { FastifyContext, FastifyContextConfig } from 'fastify/types/context'
export { RouteHandler, RouteHandlerMethod, RouteOptions, RouteShorthandMethod, RouteShorthandOptions, RouteShorthandOptionsWithHandler, RouteGenericInterface } from 'fastify/types/route'
